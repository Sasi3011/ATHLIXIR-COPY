    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/" className="text-gray-300 hover:text-white transition duration-150">
                  Training & Performance Assistance
                </Link>
              </li>
              <li>
                <Link to="/" className="text-gray-300 hover:text-white transition duration-150">
          ...
          <div>
            ...
            <div className="flex">
              ...
              />
              <button className="bg-yellow-400 hover:bg-yellow-500 px-4 py-2 rounded-r-md transition duration-150">
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>Copyright © {currentYear} ATHLIXIR. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
